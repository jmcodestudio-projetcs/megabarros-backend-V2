package br.com.megabarros.backendmodule.application.usecase;

import br.com.megabarros.backendmodule.application.policy.PasswordPolicy;
import br.com.megabarros.backendmodule.application.port.in.ChangePasswordUseCase;
import br.com.megabarros.backendmodule.application.port.out.AuditLogPort;
import br.com.megabarros.backendmodule.application.port.out.PasswordHasherPort;
import br.com.megabarros.backendmodule.application.port.out.RefreshTokenStorePort;
import br.com.megabarros.backendmodule.application.port.out.UsuarioRepositoryPort;
import br.com.megabarros.backendmodule.application.usecase.exception.InvalidCredentialsException;
