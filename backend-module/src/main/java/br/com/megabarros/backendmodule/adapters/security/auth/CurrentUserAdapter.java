package br.com.megabarros.backendmodule.adapters.security.auth;

import br.com.megabarros.backendmodule.application.port.out.CurrentUserPort;
...
public class CurrentUserAdapter implements CurrentUserPort {
    ...
    public Long userId() {
        ...
        if (auth.getPrincipal() instanceof br.com.megabarros.backendmodule.adapters.security.jwt.JwtAuthenticationFilter.Principal p) {
            return p.userId();
        }
        return null;
    }
